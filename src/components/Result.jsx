...
function Result() {
  ...
  return (
    <>
      <div className="flex flex-col md:flex-row justify-center items-center mt-8 px-6 py-10 gap-8">
        ...
        <div className="w-full md:w-1/2 text-left order-2 md:order-2">
          <h2 className="text-white text-[1.6rem] sm:text-[1.8rem] md:text-[2.4rem] leading-snug text-justify">
  ...
  <p className="inline-block border-b-2 border-gray-300 text-orange-500 font-bold text-[1.2rem] sm:text-[1.3rem] md:text-[1.4rem]">
    ...
    <span className="word">Recall</span>
      ...
      <div className="w-full overflow-hidden whitespace-nowrap py-4 bg-gradient-to-r from-yellow-800 via-yellow-300 to-yellow-100">
        <div className="animate-marquee-left inline-block">
          <ul className="flex gap-12 font-bold text-black text-xl">
      ...
      <div className="w-full overflow-hidden whitespace-nowrap py-4 bg-gradient-to-r from-[#16213e] to-[#1a1a2e]">
        <div className="animate-marquee-right inline-block">
          <ul className="flex gap-12 font-bold text-white text-xl">
